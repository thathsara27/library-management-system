...
import { addSupplier } from "../../services/supplierService.js";
...
export default function AddSupplier() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(err);
            alert("Error adding supplier. Check console details.");
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', maxWidth: '800px', margin: '0 auto', width: '100%' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    ...
                    <p style={{ color: 'var(--color-text-muted)', marginTop: '0.25rem' }}>Register a new book supplier or donation organization.</p>
                </div>
                <button 
