        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div>
                <p style={{ fontSize: '0.875rem', color: '#3b82f6', fontWeight: 600, marginBottom: '1rem' }}>
                    Book Inventory <span style={{ color: '#9ca3af', margin: '0 0.5rem' }}>&gt;</span> <span style={{ color: '#111827' }}>Edit Book</span>
                </p>
                <h2 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#111827' }}>Update Book Info</h2>
                <p style={{ color: '#6b7280', marginTop: '0.25rem' }}>Modify the details for {formData.title || "this book"} below.</p>
            </div>

            {/* Form Card */}
            <div style={{ backgroundColor: 'white', borderRadius: '1rem', padding: '2.5rem', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '1rem', paddingTop: '2rem', borderTop: '1px solid #f3f4f6', gap: '1rem' }}>
                        ...
                        <button type="submit" disabled={isLoading} style={{ padding: '0.75rem 2rem', backgroundColor: '#14b8a6', color: 'white', fontWeight: 600, border: 'none', borderRadius: '99px', display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                            <Save size={20} />
                            {isLoading ? "Saving..." : "Update Book Record"}
                        </button>
                    </div>
